/*
Displays the home page with the header on top, followed by the upcoming movies in horizontal view with a scroll bar.
Also displays released movies in the left and search filters on the right
*/
...
const Home = (props) => {
    ...
    /*
    Handlers to set the inputs from the filters
    */
    ...
    /* On clicking the apply filter button, the below handler will be called.  
     * Builds the query string from the applied filters and post it using Axios to refine the search and 
    ...
    return (
        <div>
            ...
            */}
            ...
            {/*
            Displays the Upcoming movies scroll
            */}
