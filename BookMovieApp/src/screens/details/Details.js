/*
 * Displays the details of the movie with its trailer video when the released movie 
 * tile is clicked on the home page. This page also allows the user to book a show of the same movie.
 */
