...
const Header = (props) => {
    ...
    */
    ...
    /*
     to set the state of any modal open to track the status
    */
    ...
    /*
     to set the state of any modal closed to track the status
    */
    ...
    */
    ...
    /*
    for storing the inputs of username and password by the user
    */
    ...
    */
        ...
        if (username && loginPassword) {
            ...
            */
            ...
            axios.post(props.baseUrl + "auth/login", {}, {
                ...
                /* take the user to the book show page when the book show 
                 * button is clicked without logging in
                 */
                ...
                function (error) {
                    if (error.response) {
                        /*
                        Request has been made and server responded
                        */
    ...
    /*
    Handlers for storing the inputs by the user for registration details
    */
